...
| Documentation | Pass | Required docs exist: setup, API, safety/privacy/accessibility, testing, placeholders/secrets, deployment, and this checklist. | Keep docs updated with every new env var, provider, secret, workflow, or safety boundary. | None | None. |
