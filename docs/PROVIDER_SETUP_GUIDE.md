...
AWS_TEXTRACT_ACCESS_KEY_ID=<access key>
AWS_TEXTRACT_SECRET_ACCESS_KEY=<secret key>
```
...
AWS_REKOGNITION_ACCESS_KEY_ID=<access key>
AWS_REKOGNITION_SECRET_ACCESS_KEY=<secret key>
